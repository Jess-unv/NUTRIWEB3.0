  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F8FFF9]">
        <div className="text-[#2E8B57] font-bold text-2xl animate-pulse">Cargando dietas...</div>
      </div>
    );
  }
                                ...
                                {detallesDia.map((detalle: any, idx: number) => (
                                  <div key={idx} className="p-5 rounded-2xl border-2 border-[#F0FFF4] bg-[#F8FFF9] shadow-sm">
                                    ...
                                    <div className="text-xs text-gray-500 space-y-1 uppercase font-bold text-center">
                                      {detalle.categoria && <p>📦 {detalle.categoria}</p>}
                                      {detalle.porcion_sugerida && <p>⚖️ {detalle.porcion_sugerida}</p>}
                                      {detalle.calorias_por_100g && <p>🔥 ~{detalle.calorias_por_100g} kcal/100g</p>}
                                    </div>
                                  </div>
                                ))}
                              </div>
