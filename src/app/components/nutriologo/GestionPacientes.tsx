                ...
                {pacientesFiltrados.map((paciente) => {
                  ...
                  return (
                    <TableRow key={paciente.id} className="border-b border-[#F0FFF4] hover:bg-[#F8FFF9] transition-colors group">
                      ...
                      <TableCell className="font-black text-[#2E8B57] text-[10px] uppercase">{paciente.objetivo}</TableCell>
                      <TableCell>
                              ...
                              <div className="space-y-8 mt-4">
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                  {[
                                    ...
                                    <div key={i} className="bg-[#F8FFF9] p-4 rounded-2xl border border-[#D1E8D5]">
                                      <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1">{item.label}</p>
                                      <p className="text-xs font-black text-[#1A3026] flex items-center gap-2">
                                        {item.isAward && <Award size={14} className="text-yellow-500" />}
                                        {item.val}
                                      </p>
                                    </div>
                                  ))}
                                    ...
                                    {['L', 'M', 'X', 'J', 'V', 'S', 'D'].map((dia, idx) => {
                                      ...
                                      return (
                                        <div key={dia} className="text-center">
                                          ...
                                          <div className="h-28 w-full bg-[#F0FFF4] rounded-xl flex items-end justify-center border border-[#D1E8D5] overflow-hidden">
                                            <div 
